...
require "Bimbol Engine/WB/wb"
require "Bimbol Engine/WB/voblist"
...
require "Bimbol Engine/Function/GameModeStarted"
...
function VersionBimbolEngine(playerid)
	SendPlayerMessage(playerid, 205, 50, 135, "== Version of Bimbol Engine: 0.3 Alpha ==");
end
...
print("=============================================");
print("  Bimbol Engine v0.3 Alpha has been loaded    ");
print("=============================================");